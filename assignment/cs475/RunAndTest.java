...
public class RunAndTest {
   ...
   public static final String DATA_DIRECTORY_PATH = "/Users/bersakain/Documents/workspace/ML/assignment/Data/";
   public static final String MODEL_DIRECTORY_PATH = "/Users/bersakain/Documents/workspace/ML/assignment/Models/";
   public static final String PREDICTIONS_DIRECTORY_PATH = "/Users/bersakain/Documents/workspace/ML/assignment/Preds/";
...
//      RunAndTest myRun = new RunAndTest(Algorithm.LOGISTICAL_REGRESSION);
   ...
   private void train(Dataset dataset) throws Exception {
   ...
   private void predict(Dataset dataset, Filetype filetype) throws Exception {
      @SuppressWarnings("unchecked")
